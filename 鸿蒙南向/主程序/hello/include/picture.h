...
#define IMAGE_MAXSIZE_ISOFTSTONE         20532
...
extern const unsigned char img_ppm[4608];
extern const unsigned char img_nfc_on[8192];
extern const unsigned char img_nfc_off[8192];
//weather
